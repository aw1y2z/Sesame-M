...
public class SimpleXpathParser {
     ...
     * 解析并执行 XPath 查询
     */
    public static List<io.github.aw1y2z.sesame.hook.SimpleViewImage> evaluate(io.github.aw1y2z.sesame.hook.SimpleViewImage root, String xpath) {
        List<io.github.aw1y2z.sesame.hook.SimpleViewImage> results = new ArrayList<>();
     ...
     * 查找匹配指定类名和属性的元素
     */
    private static List<io.github.aw1y2z.sesame.hook.SimpleViewImage> findElements(
            io.github.aw1y2z.sesame.hook.SimpleViewImage root,
            String className,
            String attrName,
            String attrValue,
            boolean contains
    ...
    private static void findElementsRecursive(
            io.github.aw1y2z.sesame.hook.SimpleViewImage node,
            String className,
            String attrName,
            String attrValue,
            boolean contains,
            List<io.github.aw1y2z.sesame.hook.SimpleViewImage> results
    ) {
        ...
        // 递归遍历子节点
        for (io.github.aw1y2z.sesame.hook.SimpleViewImage child : node.getChildren()) {
     ...
     * 查找指定类名的元素
     */
    private static List<io.github.aw1y2z.sesame.hook.SimpleViewImage> findElementsByTag(io.github.aw1y2z.sesame.hook.SimpleViewImage root, String className) {
        List<io.github.aw1y2z.sesame.hook.SimpleViewImage> results = new ArrayList<>();
